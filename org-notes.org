...
* COMMENT Using deft
:PROPERTIES:
:ID:       A769B026-295E-4C77-A711-C2F222C0AB0A
:END:
...
* UNDERWAY Experimental: auto-log of capture to diary
:PROPERTIES:
:DATE:     <2016-03-27 Sun 12:33>
:ID:       A76A6E7C-8B2A-450E-8D39-645F6B2CA21F
:END:
...
4. SOURCE_FILE path property
5. Subtree ID (for link)
...
#+RESULTS:
: A76A6E7C-8B2A-450E-8D39-645F6B2CA21F
...
#+RESULTS:
| Trying to get elements for capture extension | :test:other_tag: |
